              ...
              <v-slide-group show-arrows>
                ...
                <v-slide-item>
                  <v-chip
                    ...
                    text
                    color="yellow darken-1"
                    to="/ventas/historial/corte"
                    >Historial ventas</v-chip
                  >
                </v-slide-item>
                <v-slide-item>
                  <v-chip
                ...
                <v-slide-item>
                  <v-chip
                    ...
                    color="yellow darken-1"
                    @click="iventario()"
                    >Descargar excel de inventario</v-chip
                  >
                </v-slide-item>
                <v-slide-item>
                  <v-chip
                    ...
                    tile
                    dark
                    @click="dialogPromo = true"
                    >Añadir promociones <v-icon>mdi-plus</v-icon>
                  </v-chip>
                </v-slide-item>
                <v-slide-item>
...
export default {
  ...
  methods: {
    buscar() {
      axios
        .post(
          "http://178.128.183.223:3333/api/v1/administrador/productos/busqueda/nombre",
          {
    ...
    iventario() {
      ...
      this.descarga = true;
      let execlName = "Inventario.xlsx";
      ////console.log(execlName);
      axios({
        url:
          "http://178.128.183.223:3333/api/v1/administrador/generar-hoja/productos/actual", // Interface name
        method: "get",
        headers: {
          Authorization: "Bearer " + localStorage.token,
        },
    ...
    eliminarProducto(id) {
      axios
        .put(
          "http://178.128.183.223:3333/api/v1/administrador/productos/inhabilitar/" +
            id,
          {},
          {
            headers: {
